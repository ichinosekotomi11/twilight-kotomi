...
type User struct {
	...
	EmbyBoundAt      int64  `json:"emby_bound_at,omitempty"`
	...
	RetentionGraceUntil   int64    `json:"retention_grace_until,omitempty"`
	RetentionExpiredAt    int64    `json:"retention_expired_at,omitempty"`
