...
type Config struct {
	...
	TelegramStatsEnabled                       bool
	TelegramStatsTimezone                      string
	TelegramStatsMediaRankEnabled              bool
	TelegramStatsMediaRankDailyEnabled         bool
	TelegramStatsMediaRankWeeklyEnabled        bool
	TelegramStatsMediaRankMonthlyEnabled       bool
	TelegramStatsMediaRankDailyTime            string
	TelegramStatsMediaRankWeeklyTime           string
	TelegramStatsMediaRankMonthlyTime          string
	TelegramStatsUserMinutesRankEnabled        bool
	TelegramStatsUserMinutesRankDailyEnabled   bool
	TelegramStatsUserMinutesRankWeeklyEnabled  bool
	TelegramStatsUserMinutesRankMonthlyEnabled bool
	TelegramStatsUserMinutesRankDailyTime      string
	TelegramStatsUserMinutesRankWeeklyTime     string
	TelegramStatsUserMinutesRankMonthlyTime    string
	TelegramStatsPushChatID                    string
	TelegramStatsTopLimit                      int
	...
	BangumiAppID                               string
	MoviePilotEnabled                          bool
	MoviePilotURL                              string
	MoviePilotUsername                         string
	MoviePilotPassword                         string
	MoviePilotAccessToken                      string
	MoviePilotDownloadPointsEnabled            bool
	MoviePilotDownloadPointsPerGB              int
	...
	ManualRenewCodeDisabled         bool
	RetentionEnabled                bool
	RetentionActivityDays           int
	RetentionRequiredMinutes        int
	RetentionGraceDays              int
	RegistrationCodeExchangeEnabled bool
	RegistrationCodeExchangeCost    int
	RegistrationCodeExchangeDays    int
	InviteEnabled                   bool
	InviteMaxDepth                  int
	InviteLimit                     int
...
func Load(path string) (Config, error) {
	...
	cfg.PublicIP = reader.stringValue(cfg.PublicIP, "Global.public_ip", "public_ip")
	cfg.PanelPublicURL = reader.stringValue(cfg.PanelPublicURL, "Global.panel_public_url", "API.panel_public_url", "panel_public_url")
	...
	cfg.TelegramStatsEnabled = reader.boolValue(cfg.TelegramStatsEnabled, "TelegramStats.enabled", "telegram_stats_enabled")
	cfg.TelegramStatsTimezone = reader.stringValue(cfg.TelegramStatsTimezone, "TelegramStats.timezone", "telegram_stats_timezone")
	cfg.TelegramStatsMediaRankEnabled = reader.boolValue(cfg.TelegramStatsMediaRankEnabled, "TelegramStats.media_rank_enabled", "telegram_stats_media_rank_enabled")
	cfg.TelegramStatsMediaRankDailyEnabled = reader.boolValue(cfg.TelegramStatsMediaRankDailyEnabled, "TelegramStats.media_rank_daily_enabled", "telegram_stats_media_rank_daily_enabled")
	cfg.TelegramStatsMediaRankWeeklyEnabled = reader.boolValue(cfg.TelegramStatsMediaRankWeeklyEnabled, "TelegramStats.media_rank_weekly_enabled", "telegram_stats_media_rank_weekly_enabled")
	cfg.TelegramStatsMediaRankMonthlyEnabled = reader.boolValue(cfg.TelegramStatsMediaRankMonthlyEnabled, "TelegramStats.media_rank_monthly_enabled", "telegram_stats_media_rank_monthly_enabled")
	cfg.TelegramStatsMediaRankDailyTime = reader.stringValue(cfg.TelegramStatsMediaRankDailyTime, "TelegramStats.media_rank_daily_time", "telegram_stats_media_rank_daily_time")
	cfg.TelegramStatsMediaRankWeeklyTime = reader.stringValue(cfg.TelegramStatsMediaRankWeeklyTime, "TelegramStats.media_rank_weekly_time", "telegram_stats_media_rank_weekly_time")
	cfg.TelegramStatsMediaRankMonthlyTime = reader.stringValue(cfg.TelegramStatsMediaRankMonthlyTime, "TelegramStats.media_rank_monthly_time", "telegram_stats_media_rank_monthly_time")
	cfg.TelegramStatsUserMinutesRankEnabled = reader.boolValue(cfg.TelegramStatsUserMinutesRankEnabled, "TelegramStats.user_minutes_rank_enabled", "telegram_stats_user_minutes_rank_enabled")
	cfg.TelegramStatsUserMinutesRankDailyEnabled = reader.boolValue(cfg.TelegramStatsUserMinutesRankDailyEnabled, "TelegramStats.user_minutes_rank_daily_enabled", "telegram_stats_user_minutes_rank_daily_enabled")
	cfg.TelegramStatsUserMinutesRankWeeklyEnabled = reader.boolValue(cfg.TelegramStatsUserMinutesRankWeeklyEnabled, "TelegramStats.user_minutes_rank_weekly_enabled", "telegram_stats_user_minutes_rank_weekly_enabled")
	cfg.TelegramStatsUserMinutesRankMonthlyEnabled = reader.boolValue(cfg.TelegramStatsUserMinutesRankMonthlyEnabled, "TelegramStats.user_minutes_rank_monthly_enabled", "telegram_stats_user_minutes_rank_monthly_enabled")
	cfg.TelegramStatsUserMinutesRankDailyTime = reader.stringValue(cfg.TelegramStatsUserMinutesRankDailyTime, "TelegramStats.user_minutes_rank_daily_time", "telegram_stats_user_minutes_rank_daily_time")
	cfg.TelegramStatsUserMinutesRankWeeklyTime = reader.stringValue(cfg.TelegramStatsUserMinutesRankWeeklyTime, "TelegramStats.user_minutes_rank_weekly_time", "telegram_stats_user_minutes_rank_weekly_time")
	cfg.TelegramStatsUserMinutesRankMonthlyTime = reader.stringValue(cfg.TelegramStatsUserMinutesRankMonthlyTime, "TelegramStats.user_minutes_rank_monthly_time", "telegram_stats_user_minutes_rank_monthly_time")
	cfg.TelegramStatsPushChatID = reader.stringValue(cfg.TelegramStatsPushChatID, "TelegramStats.push_chat_id", "telegram_stats_push_chat_id")
	cfg.TelegramStatsTopLimit = reader.intValue(cfg.TelegramStatsTopLimit, "TelegramStats.top_limit", "telegram_stats_top_limit")
	...
	cfg.MoviePilotEnabled = reader.boolValue(cfg.MoviePilotEnabled, "MoviePilot.enabled", "moviepilot_enabled")
	cfg.MoviePilotURL = reader.stringValue(cfg.MoviePilotURL, "MoviePilot.url", "moviepilot_url")
	cfg.MoviePilotUsername = reader.stringValue(cfg.MoviePilotUsername, "MoviePilot.username", "moviepilot_username")
	cfg.MoviePilotPassword = reader.stringValue(cfg.MoviePilotPassword, "MoviePilot.password", "moviepilot_password")
	cfg.MoviePilotAccessToken = reader.stringValue(cfg.MoviePilotAccessToken, "MoviePilot.access_token", "moviepilot_access_token")
	cfg.MoviePilotDownloadPointsEnabled = reader.boolValue(cfg.MoviePilotDownloadPointsEnabled, "MoviePilot.download_points_enabled", "moviepilot_download_points_enabled")
	cfg.MoviePilotDownloadPointsPerGB = reader.intValue(cfg.MoviePilotDownloadPointsPerGB, "MoviePilot.download_points_per_gb", "moviepilot_download_points_per_gb")
	...
	cfg.InitialExpiryDays = reader.intValue(cfg.InitialExpiryDays, "SAR.initial_expiry_days", "Register.initial_expiry_days", "initial_expiry_days")
	...
	cfg.ManualRenewCodeDisabled = !reader.boolValue(!cfg.ManualRenewCodeDisabled, "SAR.manual_renew_code_enabled", "manual_renew_code_enabled")
	cfg.RetentionEnabled = reader.boolValue(cfg.RetentionEnabled, "SAR.retention_enabled", "retention_enabled")
	cfg.RetentionActivityDays = reader.intValue(cfg.RetentionActivityDays, "SAR.retention_activity_days", "retention_activity_days")
	cfg.RetentionRequiredMinutes = reader.intValue(cfg.RetentionRequiredMinutes, "SAR.retention_required_minutes", "retention_required_minutes")
	cfg.RetentionGraceDays = reader.intValue(cfg.RetentionGraceDays, "SAR.retention_grace_days", "retention_grace_days")
	cfg.RegistrationCodeExchangeEnabled = reader.boolValue(cfg.RegistrationCodeExchangeEnabled, "SAR.registration_code_exchange_enabled", "registration_code_exchange_enabled")
	cfg.RegistrationCodeExchangeCost = reader.intValue(cfg.RegistrationCodeExchangeCost, "SAR.registration_code_exchange_cost", "registration_code_exchange_cost")
	cfg.RegistrationCodeExchangeDays = reader.intValue(cfg.RegistrationCodeExchangeDays, "SAR.registration_code_exchange_days", "registration_code_exchange_days")
...
func defaults() Config {
	return Config{
		...
		TelegramStatsEnabled:                       true,
		TelegramStatsTimezone:                      "Asia/Shanghai",
		TelegramStatsMediaRankEnabled:              true,
		TelegramStatsMediaRankDailyEnabled:         true,
		TelegramStatsMediaRankWeeklyEnabled:        true,
		TelegramStatsMediaRankMonthlyEnabled:       true,
		TelegramStatsMediaRankDailyTime:            "20:00",
		TelegramStatsMediaRankWeeklyTime:           "20:00",
		TelegramStatsMediaRankMonthlyTime:          "20:00",
		TelegramStatsUserMinutesRankEnabled:        true,
		TelegramStatsUserMinutesRankDailyEnabled:   true,
		TelegramStatsUserMinutesRankWeeklyEnabled:  true,
		TelegramStatsUserMinutesRankMonthlyEnabled: true,
		TelegramStatsUserMinutesRankDailyTime:      "21:00",
		TelegramStatsUserMinutesRankWeeklyTime:     "21:00",
		TelegramStatsUserMinutesRankMonthlyTime:    "21:00",
		TelegramStatsPushChatID:                    "",
		TelegramStatsTopLimit:                      10,
		...
		ManualRenewCodeDisabled:              false,
		RetentionEnabled:                     false,
		RetentionActivityDays:                30,
		RetentionRequiredMinutes:             60,
		RetentionGraceDays:                   5,
		MoviePilotDownloadPointsEnabled:      false,
		MoviePilotDownloadPointsPerGB:        1,
		RegistrationCodeExchangeEnabled:      false,
		RegistrationCodeExchangeCost:         1000,
		RegistrationCodeExchangeDays:         30,
		InviteEnabled:                        true,
		InviteMaxDepth:                       3,
		InviteLimit:                          10,
...
func applyEnv(cfg *Config) {
	...
	if v := os.Getenv("TWILIGHT_PUBLIC_IP"); v != "" {
		cfg.PublicIP = strings.TrimSpace(v)
	}
