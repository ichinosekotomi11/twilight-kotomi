...
var schedulerJobs = []map[string]any{
	...
	{"id": "telegram_media_rank_daily", "name": "Telegram 媒体日榜", "description": "每天推送 Emby 电视剧/电影播放榜。", "manual_only": false, "enabled": true},
	{"id": "telegram_media_rank_weekly", "name": "Telegram 媒体周榜", "description": "每周推送 Emby 电视剧/电影播放榜。", "manual_only": false, "enabled": true},
	{"id": "telegram_media_rank_monthly", "name": "Telegram 媒体月榜", "description": "每月推送 Emby 电视剧/电影播放榜。", "manual_only": false, "enabled": true},
	{"id": "telegram_user_minutes_daily", "name": "Telegram 用户日榜", "description": "每天推送 Emby 用户播放分钟排行榜。", "manual_only": false, "enabled": true},
	{"id": "telegram_user_minutes_weekly", "name": "Telegram 用户周榜", "description": "每周推送 Emby 用户播放分钟排行榜。", "manual_only": false, "enabled": true},
	{"id": "telegram_user_minutes_monthly", "name": "Telegram 用户月榜", "description": "每月推送 Emby 用户播放分钟排行榜。", "manual_only": false, "enabled": true},
