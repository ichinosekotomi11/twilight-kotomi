...
func (a *App) registerRoutes() {
	...
	a.add(http.MethodPost, "/api/v1/auth/password/email/request", AuthPublic, a.handleForgotPasswordEmailRequest)
	a.add(http.MethodPost, "/api/v1/auth/password/email/reset", AuthPublic, a.handleForgotPasswordEmailReset)
	...
	a.add(http.MethodPost, "/api/v1/users/me/email/send-code", AuthUser, a.handleSendEmailCode)
	a.add(http.MethodPost, "/api/v1/users/me/email/verify", AuthUser, a.handleVerifyEmailCode)
	...
	a.add(http.MethodGet, "/api/v1/emby/lines", AuthUser, a.handleEmbyLines)
	a.add(http.MethodGet, "/api/v1/emby/stats/today", AuthUser, a.handleEmbyStatsToday)
	a.add(http.MethodGet, "/api/v1/emby/stats/rank", AuthUser, a.handleEmbyStatsRank)
	a.add(http.MethodGet, "/api/v1/emby/stats/user-minutes", AuthUser, a.handleEmbyStatsUserMinutes)
	a.add(http.MethodGet, "/api/v1/emby/stats/debug", AuthAdmin, a.handleEmbyStatsDebug)
	...
	a.add(http.MethodGet, "/api/v1/moviepilot/status", AuthUser, a.handleMoviePilotStatus)
	a.add(http.MethodGet, "/api/v1/moviepilot/search", AuthUser, a.handleMoviePilotSearch)
	a.add(http.MethodPost, "/api/v1/moviepilot/download", AuthUser, a.handleMoviePilotDownload)
...
func (a *App) registerAdminRoutes() {
	...
	a.add(http.MethodPost, "/api/v1/admin/users/:uid/emby/enable", AuthAdmin, a.handleAdminToggleEmby)
	a.add(http.MethodPost, "/api/v1/admin/users/:uid/emby/disable", AuthAdmin, a.handleAdminToggleEmby)
	...
	a.add(http.MethodPost, "/api/v1/admin/users/:uid/bind-email", AuthAdmin, a.handleAdminBindUserEmail)
	a.add(http.MethodPost, "/api/v1/admin/users/:uid/email/verified", AuthAdmin, a.handleAdminSetUserEmailVerified)
...
func (a *App) registerBatchRoutes() {
	...
	a.add(http.MethodPost, "/api/v1/batch/users/promote-whitelist", AuthAdmin, a.handleBatchPromoteWhitelist)
...
func (a *App) registerStatsInviteSigninAnnouncementRoutes() {
	...
	a.add(http.MethodPost, "/api/v1/signin/exchange-registration-code", AuthUser, a.handleSigninExchangeRegistrationCode)
