...
export interface EmbyInfo {
  ...
  monthly_playback_minutes?: number;
  monthly_playback_str?: string;
  playback_cycle_start?: number;
  playback_cycle_end?: number;
  playback_cycle_range?: string;
  message?: string;
}
...
export interface EmbyLineInfo {
  name: string;
  url: string;
}

export interface EmbyLinesInfo {
  lines: EmbyLineInfo[];
  whitelist_lines?: EmbyLineInfo[];
  requires_emby_account?: boolean;
  requires_renewal?: boolean;
  emby_disabled_by_expiry?: boolean;
}

export interface EmbyRankItem {
  key?: string;
  title: string;
  play_count: number;
...
export interface EmbyUserMinutesRankItem {
  uid: number;
  username: string;
...
export interface EmbyTodayStats {
  period: string;
  start_at: number;
  end_at: number;
  series_top: EmbyRankItem[];
  movie_top: EmbyRankItem[];
  user_minutes_top: EmbyUserMinutesRankItem[];
}

export interface EmbyRankResponse {
  period: string;
  type: "movie" | "series";
  start_at: number;
  end_at: number;
...
export interface EmbyUserMinutesRankResponse {
  period: string;
  start_at: number;
  end_at: number;
  items: EmbyUserMinutesRankItem[];
}
...
export interface SigninSummary {
  ...
  registration_code_exchange?: RegistrationCodeExchangeConfig;
}

export interface RegistrationCodeExchangeConfig {
  enabled: boolean;
  cost: number;
  days: number;
  affordable?: boolean;
...
export interface RegistrationCodeExchangeResult {
  code: string;
  cost: number;
  days: number;
  currency_name: string;
